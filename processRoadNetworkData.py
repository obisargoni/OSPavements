...
def run():
    ...
    gdfORLink = gdfORLink.reindex(columns = ['u','v','key','osmid','u_original','v_original', 'strg_id', 'sub_strg_id', 'strg_ang_id', 'class', 'geometry'])
    ...
    gdfORLink = gdfORLink.reindex(columns = ['fid', 'geometry', 'u','v','key', 'class'])
